    ...
    <Card className="w-full max-w-md border-neutral-800 bg-neutral-900/60 backdrop-blur-md shadow-2xl text-neutral-100">
      <CardHeader className="space-y-1">
        ...
        <CardDescription className="text-neutral-400 text-center">
          Monte seu portfólio profissional em minutos
        </CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <div className="space-y-1">
            <Label htmlFor="username" className="text-neutral-300">Nome de Usuário (Username)</Label>
            <div className="relative flex items-center">
              <span className="absolute left-3 text-neutral-600 text-sm font-medium">devfolio.com/</span>
              <Input
                id="username"
                type="text"
            ...
            {errors.username ? (
              ...
              <span className="text-[10px] text-neutral-500">Este será o endereço público do seu portfólio.</span>
            )}
          </div>
          ...
          <Button
            ...
            className="w-full bg-violet-600 hover:bg-violet-500 text-white font-medium cursor-pointer transition-all duration-200 shadow-lg shadow-violet-600/20 active:scale-[0.98] mt-3"
          >
            {isRegistering ? (
              <>
