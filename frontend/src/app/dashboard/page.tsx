...
export default function DashboardPage() {
  ...
  return (
    <div className="max-w-6xl animate-in fade-in duration-500 font-sans">
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 items-start">
        ...
        {/* Right Sidebar: Developer Card */}
        <div className="lg:col-span-1 lg:sticky lg:top-8 flex flex-col items-center gap-4">
          <h2 className="text-xl font-bold text-neutral-900 dark:text-neutral-50 tracking-tight self-start">
            Sua Developer Card
          </h2>
          {profile && <DeveloperCard profile={profile} showDetails={true} />}
        </div>
      </div>
    </div>
  );
